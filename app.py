...
st.markdown("""
<div style="width:100%;border-radius:12px;overflow:hidden;margin-bottom:1.1rem;
            box-shadow:0 2px 12px rgba(0,0,0,0.08);">
<svg viewBox="0 0 1200 160" xmlns="http://www.w3.org/2000/svg"
  ...
  <defs>
    ...
    <linearGradient id="lineGrad1" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%"   stop-color="#ff4b4b" stop-opacity="0"/>
      <stop offset="30%"  stop-color="#ff4b4b" stop-opacity="0.9"/>
      <stop offset="70%"  stop-color="#ff4b4b" stop-opacity="0.9"/>
  ...
  <!-- Background -->
  <rect width="1200" height="160" fill="url(#bgGrad)"/>

  <!-- Grid lines orizzontali sottili -->
  <line x1="0" y1="40"  x2="1200" y2="40"  stroke="#ffffff" stroke-opacity="0.03" stroke-width="1"/>
  <line x1="0" y1="80"  x2="1200" y2="80"  stroke="#ffffff" stroke-opacity="0.03" stroke-width="1"/>
  <line x1="0" y1="120" x2="1200" y2="120" stroke="#ffffff" stroke-opacity="0.03" stroke-width="1"/>

  <!-- Grid lines verticali sottili -->
  <line x1="200"  y1="0" x2="200"  y2="160" stroke="#ffffff" stroke-opacity="0.02" stroke-width="1"/>
  <line x1="400"  y1="0" x2="400"  y2="160" stroke="#ffffff" stroke-opacity="0.02" stroke-width="1"/>
  <line x1="600"  y1="0" x2="600"  y2="160" stroke="#ffffff" stroke-opacity="0.02" stroke-width="1"/>
  <line x1="800"  y1="0" x2="800"  y2="160" stroke="#ffffff" stroke-opacity="0.02" stroke-width="1"/>
  <line x1="1000" y1="0" x2="1000" y2="160" stroke="#ffffff" stroke-opacity="0.02" stroke-width="1"/>

  <!-- Linea principale (shock scenario — stile candlestick/equity curve) -->
  <polyline
    points="0,120 60,115 90,100 130,108 170,72 200,65 230,80 260,55 300,60 340,90 370,70 400,50 430,68 460,42 500,55 530,80 560,62 600,48 640,70 670,52 700,65 740,38 780,55 820,45 860,62 900,50 940,72 980,60 1010,80 1050,55 1090,68 1130,50 1160,62 1200,48"
    fill="none" stroke="url(#lineGrad1)" stroke-width="2.2" stroke-linejoin="round"
    filter="url(#glow1)"/>

  <!-- Area fill sotto la linea principale -->
  <polygon
    points="0,120 60,115 90,100 130,108 170,72 200,65 230,80 260,55 300,60 340,90 370,70 400,50 430,68 460,42 500,55 530,80 560,62 600,48 640,70 670,52 700,65 740,38 780,55 820,45 860,62 900,50 940,72 980,60 1010,80 1050,55 1090,68 1130,50 1160,62 1200,48 1200,160 0,160"
    fill="#ff4b4b" fill-opacity="0.04"/>

  <!-- Linea secondaria (rates curve) -->
  <polyline
    points="0,90 80,95 150,85 220,100 290,88 360,105 420,92 480,110 550,95 620,108 680,90 750,102 820,88 890,96 960,85 1030,100 1100,88 1200,95"
    fill="none" stroke="url(#lineGrad2)" stroke-width="1.4" stroke-linejoin="round"
    filter="url(#glow2)" stroke-dasharray="4,3"/>

  <!-- Linea terziaria (spread curve) -->
  <polyline
    points="0,130 100,125 200,132 300,120 400,128 500,118 600,125 700,115 800,122 900,118 1000,125 1100,120 1200,128"
    fill="none" stroke="url(#lineGrad3)" stroke-width="1.2" stroke-linejoin="round"
    filter="url(#glow2)"/>

  <!-- Punti di shock sulla linea principale (cerchietti rossi) -->
  <circle cx="170" cy="72"  r="3.5" fill="#ff4b4b" fill-opacity="0.9" filter="url(#glow1)"/>
  <circle cx="460" cy="42"  r="3.5" fill="#ff4b4b" fill-opacity="0.9" filter="url(#glow1)"/>
  <circle cx="740" cy="38"  r="4"   fill="#ff4b4b" fill-opacity="1"   filter="url(#glow1)"/>
  <circle cx="400" cy="50"  r="3"   fill="#ff6b6b" fill-opacity="0.7" filter="url(#glow2)"/>

  <!-- Linee verticali di shock (drop lines) -->
  <line x1="170" y1="72"  x2="170" y2="160" stroke="#ff4b4b" stroke-opacity="0.12" stroke-width="1" stroke-dasharray="3,3"/>
  <line x1="460" y1="42"  x2="460" y2="160" stroke="#ff4b4b" stroke-opacity="0.12" stroke-width="1" stroke-dasharray="3,3"/>
  <line x1="740" y1="38"  x2="740" y2="160" stroke="#ff4b4b" stroke-opacity="0.18" stroke-width="1" stroke-dasharray="3,3"/>

  <!-- Label "SHOCK" sul punto più basso -->
  <rect x="750" y="26" width="52" height="16" rx="3" fill="#ff4b4b" fill-opacity="0.85"/>
  <text x="776" y="37.5" font-family="monospace" font-size="9" fill="white"
        text-anchor="middle" font-weight="bold">SHOCK</text>

  <!-- Barre OHLC stilizzate a sinistra -->
  <rect x="30"  y="100" width="6" height="30" rx="1" fill="#ffffff" fill-opacity="0.06"/>
  <rect x="45"  y="90"  width="6" height="25" rx="1" fill="#ff4b4b" fill-opacity="0.3"/>
  <rect x="60"  y="95"  width="6" height="20" rx="1" fill="#34d399" fill-opacity="0.3"/>
  <rect x="75"  y="85"  width="6" height="35" rx="1" fill="#ff4b4b" fill-opacity="0.25"/>
  <rect x="90"  y="92"  width="6" height="22" rx="1" fill="#34d399" fill-opacity="0.25"/>
  <rect x="105" y="88"  width="6" height="28" rx="1" fill="#ff4b4b" fill-opacity="0.2"/>

  <!-- Testo header -->
  <text x="200" y="72" font-family="system-ui, -apple-system, sans-serif"
        font-size="28" font-weight="800" fill="white" letter-spacing="-0.5">
    Stress Test Mapping
  </text>
  <text x="201" y="92" font-family="system-ui, -apple-system, sans-serif"
        font-size="11.5" fill="#9ca3af" letter-spacing="0.5">
    Asset class drill-down  ·  Shock direction analysis  ·  Geographic exposure
  </text>

  <!-- Badge scenario count -->
  <rect x="200" y="104" width="90" height="18" rx="9" fill="#ff4b4b" fill-opacity="0.18"
        stroke="#ff4b4b" stroke-opacity="0.4" stroke-width="0.8"/>
  <text x="245" y="116.5" font-family="monospace" font-size="9.5" fill="#ff8080"
        text-anchor="middle" font-weight="600" letter-spacing="0.3">ST · ALADDIN</text>

  <!-- Decorazione angolo dx: heatmap grid -->
  <rect x="1080" y="20" width="10" height="10" rx="1" fill="#ff4b4b" fill-opacity="0.6"/>
  <rect x="1093" y="20" width="10" height="10" rx="1" fill="#ff4b4b" fill-opacity="0.3"/>
  <rect x="1106" y="20" width="10" height="10" rx="1" fill="#ff4b4b" fill-opacity="0.8"/>
  <rect x="1080" y="33" width="10" height="10" rx="1" fill="#ff4b4b" fill-opacity="0.2"/>
  <rect x="1093" y="33" width="10" height="10" rx="1" fill="#ff4b4b" fill-opacity="0.9"/>
  <rect x="1106" y="33" width="10" height="10" rx="1" fill="#ff4b4b" fill-opacity="0.4"/>
  <rect x="1080" y="46" width="10" height="10" rx="1" fill="#ff4b4b" fill-opacity="0.5"/>
  <rect x="1093" y="46" width="10" height="10" rx="1" fill="#ff4b4b" fill-opacity="0.15"/>
  <rect x="1106" y="46" width="10" height="10" rx="1" fill="#ff4b4b" fill-opacity="0.7"/>
  <text x="1093" y="72" font-family="monospace" font-size="8" fill="#6b7280"
        text-anchor="middle">RISK MATRIX</text>

  <!-- Overlay gradient bordi per fade -->
  <rect width="80"  height="160" fill="url(#bgGrad)" opacity="0.5"/>
  <rect x="1120" width="80" height="160" fill="#0e1117" opacity="0.4"/>
</svg>
</div>
""", unsafe_allow_html=True)
